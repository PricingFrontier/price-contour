...
class QuoteGrid:
    ...
    @property
    def baseline_step(self) -> int:
        """Index of the scenario value nearest 1.0 (f32; lowest on a tie)."""
        ...
    @property
...
# ---------------------------------------------------------------------------
# Ratebook evaluation and CD pass
# ---------------------------------------------------------------------------

class RatebookEvaluation:
...
class RatebookCDResult:
    """Result of one coordinate-descent pass (`run_cd_pass_py`)."""

    @property
    def factor_values(self) -> list[list[float]]: ...
    @property
    def lambdas(self) -> dict[str, float]: ...
    @property
    def constraint_bounds(self) -> dict[str, float]: ...
    ...
    def clamp_rate(self) -> float: ...
    @property
    def evaluation(self) -> RatebookEvaluation: ...
    @property
    def per_call_records(self) -> list[dict[str, object]]: ...
